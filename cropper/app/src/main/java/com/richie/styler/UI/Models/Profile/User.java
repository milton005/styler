...
public class User implements Serializable {
    ...
    @SerializedName("tribes_looking_for")
    @Expose
    private List<TribesLookingFor> tribesLookingFor = null;
    ...
    public List<TribesLookingFor> getTribesLookingFor() {
        return tribesLookingFor;
    }

    public void setTribesLookingFor(List<TribesLookingFor> tribesLookingFor) {
        this.tribesLookingFor = tribesLookingFor;
    }
}
