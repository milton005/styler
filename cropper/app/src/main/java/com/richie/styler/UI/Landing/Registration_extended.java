...
//    SpinnerAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       otherlinearlayout= (LinearLayout) findViewById(R.id.linearOtherlayout);
        ...
        gestureDetector = new GestureDetector( new Registration_extended.SwipeDetector() );
        setAdapter();
                    ...
                    if (enlarged.getVisibility() == View.VISIBLE) {
                        ...
                        if (pos != gridItems.size() - 1) {
                            ...
                            if (!gridItems.get(pos).getTribeImage().isEmpty())
                            {
                                ...
                                Picasso.with(Registration_extended.this).load(gridItems.get(pos).getTribeImage()).into(image_enlarged);
                                style.setText(gridItems.get(pos).getTribeName());
                                int dotsCount=gridItems.size();
                                dots = new ImageView[dotsCount];
                                pagerindicator.removeAllViews();
                                for (int i = 0; i < dotsCount; i++) {
                                    dots[i] = new ImageView(Registration_extended.this);
